...
public class AddEditBarcodesActivity extends AppCompatActivity {
    public static String EXTRA_ID =
            "com.example.room_livedata_recyclerview.EXTRA_ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            setTitle("Изменить штрихкод");
            editTextBarcodenum.setText(intent.getStringExtra(EXTRA_BARCODENUM));
            editTextName.setText(intent.getStringExtra(EXTRA_NAME));
            editTextDocname.setText(intent.getStringExtra(EXTRA_DOCNAME));
            editTextDocdate.setText(intent.getStringExtra(EXTRA_DOCDATE));
            editTextDocnum.setText(intent.getStringExtra(EXTRA_DOCNUM));
            editTextDate.setText(intent.getStringExtra(EXTRA_DATE));
            editTextInvnum.setText(intent.getStringExtra(EXTRA_INVNUM));
            editTextFactnum.setText(intent.getStringExtra(EXTRA_FACTNUM));
            editTextPassportnum.setText(intent.getStringExtra(EXTRA_PASSPORTNUM));
            editTextFnquantity.setText(intent.getStringExtra(EXTRA_FNQUANTITY));
            editTextFncost.setText(intent.getStringExtra(EXTRA_FNCOST));
